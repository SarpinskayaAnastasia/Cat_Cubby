...
define config.name = _("Сказ о синем коте")
...
define gui.about = _p("""Нелинейная развлекательная новелла-игра про синего кота с дополнительными мини-играми.
От ваших выборов и действий будет зависеть конец игры и судьба главного героя.
""")
...
define build.name = "MyProjectStory"
...
define config.save_directory = "MyProjectStory-1608155199"
